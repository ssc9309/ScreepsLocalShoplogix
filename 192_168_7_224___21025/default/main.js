...
var constSites = Game.spawns.Spawn1.room.find(FIND_CONSTRUCTION_SITES);
if (constSites[0])
{
}
else
...
var repairBuildings = Game.spawns.Spawn1.room.find(FIND_STRUCTURES, 
{
...
var storageBuildings = Game.spawns.Spawn1.room.find(FIND_MY_STRUCTURES,
{
    filter: 
    {
...
{
    var emptyExtentions = Game.spawns.Spawn1.room.find(FIND_MY_STRUCTURES,
    {
        filter: function(object)
        {
...
var BuildingEnergy = Game.spawns.Spawn1.room.energyAvailable;
...
{
    var name = Game.spawns.Spawn1.createCreep(transferBody);
...
else if (truckCount == 0)
{
    ...
    */
    ...
    if (truckFactor >= 1)
    {
    var name = Game.spawns.Spawn1.createCreep(truckBody);
...
else if (buildCount < buildLimit)
{
    ...
    */
    ...
    if (buildFactor >= 1)
    {
        var name = Game.spawns.Spawn1.createCreep(buildBody);
...
else if (upgradeCount < upgradeLimit)
{
    ...
    */
    ...
    if (upgradeFactor >= 1)
    {
        var name = Game.spawns.Spawn1.createCreep(upgradeBody);
        if (name != -6 && name != -4)
        {
...
else if (armyCount < armyLimit)
{
    ...
    var name = Game.spawns.Spawn1.createCreep(armyBody);
